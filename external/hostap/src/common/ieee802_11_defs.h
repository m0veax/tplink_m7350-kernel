...
#define OVERLAPPING_BSS_SCAN_PASS_DWELL 20
#define OVERLAPPING_BSS_SCAN_ACT_DWELL 10
#define OVERLAPPING_BSS_TRIGGER_SCAN_INTERVAL 300
#define OVERLAPPING_BSS_PASS_TOTAL_PER_CH 200
#define OVERLAPPING_BSS_ACT_TOTAL_PER_CH 20
#define OVERLAPPING_BSS_TRANS_DELAY_FACTOR 5
#define OVERLAPPING_BSS_SCAN_ACTIVITY_THRESH 25

#define IEEE80211_EXTCAP_2040COEX_MGMT 0x01

#define HT_2040_MAX_SCAN_INTERVAL 1800
#endif
...
#ifdef CONFIG_HT2040_COEX
struct ieee80211_obss_scan_params_ie {
	u8 eid;
	u8 len;
	u16 passive;
	u16 active;
